...
- `COMMITMENT_LEVEL`- The commitment level of transactions ("processed", "confirmed", "finalized" e.g., "finalized" 
...
- `CHECK_META_WORDS` - Set to `true` to buy tokens only if they have at least 1 social.
